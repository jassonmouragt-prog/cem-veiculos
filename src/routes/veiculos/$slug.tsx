...
import { getVehicleBySlug, subscribeToStore, formatCurrency, formatMileage } from "@/lib/db/store";
...
function VehicleDetailPage() {
  ...
  const [vehicle, setVehicle] = useState<Vehicle | undefined>(getVehicleBySlug(slug));
