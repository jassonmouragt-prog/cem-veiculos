            ...
            <CardHeader className="flex flex-row items-center justify-between pb-3 border-b border-white/5">
              ...
              <Link to="/admin/veiculos">
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-xs text-[#E8231F] hover:text-white gap-1"
                >
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="flex flex-col min-w-0">
                          ...
                          <span className="text-[11px] text-gray-400 truncate">
                            {v.modelYear} • {v.mileage.toLocaleString()} km
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 shrink-0">
                        <div className="text-right">
                          ...
                          <span
                            className={`inline-block text-[10px] font-medium px-2 py-0.2 rounded-full border capitalize ${statusBadge}`}
                          >
                            {v.status}
                          </span>
                        </div>
