        ...
        <Card className="bg-[#121212] border-white/5 overflow-hidden flex flex-col md:flex-row rounded-2xl shadow-xl">
          <div className="relative min-h-[240px] md:min-h-[300px] md:w-1/2">
            ...
            <div className="absolute inset-0 flex flex-col justify-center p-6 sm:p-8 lg:p-10">
              <span className="text-[#E8231F] font-semibold tracking-wider text-xs uppercase mb-1.5">
                REALIZE SEU SONHO
              </span>
              ...
              <p className="text-xs sm:text-sm text-gray-300 max-w-sm">
                Condições personalizadas e taxas competitivas para você sair de carro novo ainda
                hoje.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center bg-[#0d0d0d] p-6 sm:p-8 md:w-1/2 lg:p-10">
            <div className="mb-5 sm:mb-6">
              ...
              <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">
                Nossos consultores calculam na hora as melhores condições para o seu perfil junto
                aos maiores bancos parceiros. O processo é 100% online, ágil e seguro.
              </p>
            </div>
            ...
            <p className="text-[11px] text-gray-400 mt-4 text-center">
              *Aprovação sujeita à análise de crédito. Trabalhamos com as principais instituições
              financeiras.
            </p>
          </div>
        </Card>
