      ...
      <div className="container mx-auto grid items-center gap-8 px-4 lg:grid-cols-2 lg:gap-12">
        <div className="space-y-5">
          ...
          <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
            Venha tomar um café conosco, conhecer nosso estoque pessoalmente e receber um atendimento exclusivo e personalizado.
          </p>
          ...
          <div className="flex flex-col gap-3 pt-2 sm:flex-row sm:gap-4 sm:pt-3">
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <Button variant="outline" className="w-full sm:w-auto h-10 sm:h-11 border-white/10 hover:bg-white/5 text-gray-200 font-semibold text-xs sm:text-sm gap-2 rounded-lg">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="rounded-2xl overflow-hidden aspect-square border border-white/5 shadow-md">
            <img src="https://images.unsplash.com/photo-1555664424-778a195e1a48?auto=format&fit=crop&q=80&w=600" alt="Fachada C&M Veículos" className="w-full h-full object-cover" />
          </div>
          <div className="rounded-2xl overflow-hidden aspect-square relative bg-[#121212] border border-white/5 flex items-center justify-center p-6 text-center shadow-md">
            <div className="space-y-3">
              <div className="h-10 w-10 bg-brand-gradient rounded-xl mx-auto flex items-center justify-center text-white font-bold text-sm shadow-sm">CM</div>
              <h3 className="font-bold text-white text-base">C&M Veículos</h3>
              <p className="text-xs text-gray-400 leading-relaxed">Av. das Fronteiras, 1417 — Fronteiras - Teresina/PI</p>
              <a
                href="https://maps.google.com/?q=Av.+das+Fronteiras,+1417"
                target="_blank"
                rel="noopener noreferrer"
